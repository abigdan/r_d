...
```
microk8s.kubectl scale deployment l8-deployment --replicas=5 -n testenv

microk8s.kubectl get pods -o wide -n testenv
```
```
NAME                            READY   STATUS    RESTARTS   AGE   IP             NODE   NOMINATED NODE   READINESS GATES
l8-deployment-bcb99f5dc-2w8qc   1/1     Running   0          29s   10.1.227.170   r-d    <none>           <none>
l8-deployment-bcb99f5dc-cglxd   1/1     Running   0          92m   10.1.227.169   r-d    <none>           <none>
l8-deployment-bcb99f5dc-q5nxx   1/1     Running   0          92m   10.1.227.181   r-d    <none>           <none>
l8-deployment-bcb99f5dc-wcdxz   1/1     Running   0          92m   10.1.227.174   r-d    <none>           <none>
l8-deployment-bcb99f5dc-wqp7c   1/1     Running   0          29s   10.1.227.177   r-d    <none>           <none>
```
